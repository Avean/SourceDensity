...
\begin{leftcol}
  ...
  \end{minipage}\par
  \vspace{0.3cm}
  {\centering\includegraphics[width=\linewidth]{generated/rho_profiles.pdf}\par}
  \vspace{0.2cm}
  \smallfont
...
\begin{rightcol}
  ...
  \vspace{0.2cm}
  {\smallfont TEXT BETWEEN THE FIGURES (to be written).\par}
  \vspace{0.2cm}
  \includegraphics[width=\linewidth]{generated/rho_dynamic.pdf}\par
  \vspace{0.2cm}
  \smallfont
  A fixed $\rho(x)$ keeps both heads at the grafted positions. A dynamic $\rho$
  holds them there only for a while; as $\rho$ relaxes, the peaks move to the
  Turing pattern selected by the activator--inhibitor subsystem.
\end{rightcol}
